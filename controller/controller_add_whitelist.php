...
if($blacklist == "false" && $whitelist == "false"){
	...
	$msg = "<h3 style='color:green'>La whitelist $nom_domaine a bien été ajouté</h3>";
}
else if($blacklist == "true"){
	$msg = "<h3 style='color:red'>La whitelist $nom_domaine existe dans blacklist</h3>";
}
else if($whitelist == "true"){
	$msg = "<h3 style='color:red'>La whitelist $nom_domaine existe dans whitelist</h3>";
}
