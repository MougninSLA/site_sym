                  ...
                  <div class="responsive-table">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        <tr>
                          <td style="width:10%;"><?php echo $datas['id_whitelist']; ?></td>
                          <td style="width:15%;"><?php echo $datas['nom_whitelist']; ?></td>
                          <td style="width:15%;"><?php echo $datas['adresse_whitelist']; ?></td>
                          <td style="width:15%;"><?php echo $datas['pays_whitelist']; ?></td>
                          <td style="width:15%;"><?php echo $datas['ville_whitelist']; ?></td>
                          ...
                          <td style="width:5%;">
                            <?php
                              $existe = blacklist($datas['adresse_whitelist']);
                              if($existe == "true"){
                                echo '<i class="fa fa-exclamation-triangle" style="color:red;" aria-hidden="true" title="Cette adresse existe dans la blacklist. Veuillez vérifier SVP."></i>';
                              } else {
                                echo "";
                              }
                            ?>
